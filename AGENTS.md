...
## Networking & Packets
FancyMenu (which Spiffy is an addon for) uses its own custom packet system. If you need to add packets for a feature, make sure to analyze the `de.keksuccino.fancymenu.networking` package first, to understand how packets get implemented and registered.
