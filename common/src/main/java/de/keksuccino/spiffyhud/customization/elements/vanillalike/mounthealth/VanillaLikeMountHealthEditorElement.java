...
public class VanillaLikeMountHealthEditorElement extends AbstractEditorElement<VanillaLikeMountHealthEditorElement, VanillaLikeMountHealthElement> {

    public VanillaLikeMountHealthEditorElement(@NotNull VanillaLikeMountHealthElement element, @NotNull LayoutEditorScreen editor) {
