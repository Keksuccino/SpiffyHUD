...
public class PlayerArmorBarEditorElement extends AbstractEditorElement<PlayerArmorBarEditorElement, PlayerArmorBarElement> {

    public PlayerArmorBarEditorElement(@NotNull PlayerArmorBarElement element, @NotNull LayoutEditorScreen editor) {
    ...
    public void init() {
        ...
        this.addStringInputContextMenuEntryTo(this.rightClickMenu, "scale_multiplier",
                ...
                .setStackable(true)
                .setTooltipSupplier((menu, entry) -> UITooltip.of(LocalizationUtils.splitLocalizedLines("spiffyhud.elements.player_armor_bar.scale.desc")));
        ...
        this.addIntegerInputContextMenuEntryTo(this.rightClickMenu, "icon_gap",
                        ...
                        true, 1, null, null)
                .setStackable(true)
                .setTooltipSupplier((menu, entry) -> UITooltip.of(LocalizationUtils.splitLocalizedLines("spiffyhud.elements.player_armor_bar.icon_gap.desc")));
        ...
        this.addToggleContextMenuEntryTo(this.rightClickMenu, "shake_enabled",
                ...
                .setStackable(true)
                .setTooltipSupplier((menu, entry) -> UITooltip.of(LocalizationUtils.splitLocalizedLines("spiffyhud.elements.player_armor_bar.shake.desc")));
        ...
        this.rightClickMenu.addSubMenuEntry("armor_textures",
                ...
                .setTooltipSupplier((menu, entry) -> UITooltip.of(LocalizationUtils.splitLocalizedLines("spiffyhud.elements.player_armor_bar.textures.desc")));
