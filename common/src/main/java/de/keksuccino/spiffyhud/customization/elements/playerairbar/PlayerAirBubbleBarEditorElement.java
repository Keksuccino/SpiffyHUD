...
public class PlayerAirBubbleBarEditorElement extends AbstractEditorElement<PlayerAirBubbleBarEditorElement, PlayerAirBubbleBarElement> {

    public PlayerAirBubbleBarEditorElement(@NotNull PlayerAirBubbleBarElement element, @NotNull LayoutEditorScreen editor) {
    ...
    public void init() {
        ...
        this.addStringInputContextMenuEntryTo(this.rightClickMenu, "scale_multiplier",
                ...
                .setStackable(true)
                .setTooltipSupplier((menu, entry) -> UITooltip.of(LocalizationUtils.splitLocalizedLines("spiffyhud.elements.player_air_bubble_bar.scale.desc")));
        ...
        this.addIntegerInputContextMenuEntryTo(this.rightClickMenu, "bubble_gap",
                        ...
                        true, 1, null, null)
                .setStackable(true)
                .setTooltipSupplier((menu, entry) -> UITooltip.of(LocalizationUtils.splitLocalizedLines("spiffyhud.elements.player_air_bubble_bar.bubble_gap.desc")));
        ...
        this.addIntegerInputContextMenuEntryTo(this.rightClickMenu, "pop_duration_ms",
                ...
                .setStackable(true)
                .setTooltipSupplier((menu, entry) -> UITooltip.of(LocalizationUtils.splitLocalizedLines("spiffyhud.elements.player_air_bubble_bar.pop_duration.desc")));
        ...
        this.addToggleContextMenuEntryTo(this.rightClickMenu, "shake_enabled",
                ...
                .setStackable(true)
                .setTooltipSupplier((menu, entry) -> UITooltip.of(LocalizationUtils.splitLocalizedLines("spiffyhud.elements.player_air_bubble_bar.shake.desc")));
        ...
        this.rightClickMenu.addSubMenuEntry("air_textures",
                ...
                .setTooltipSupplier((menu, entry) -> UITooltip.of(LocalizationUtils.splitLocalizedLines("spiffyhud.elements.player_air_bubble_bar.textures.desc")));
