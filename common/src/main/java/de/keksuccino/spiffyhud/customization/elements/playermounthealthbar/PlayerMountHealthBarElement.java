...
public class PlayerMountHealthBarElement extends AbstractElement {
    ...
    private void drawHearts(@NotNull GuiGraphicsExtractor graphics, int originX, int originY, @NotNull MountData data, @NotNull RenderMetrics metrics, float scale) {
