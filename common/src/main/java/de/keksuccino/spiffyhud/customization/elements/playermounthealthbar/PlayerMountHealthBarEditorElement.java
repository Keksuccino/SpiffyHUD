...
public class PlayerMountHealthBarEditorElement extends AbstractEditorElement {
    ...
    public void init() {
        ...
        this.addStringInputContextMenuEntryTo(this.rightClickMenu, "scale_multiplier",
                        ...
                        (editorElement, value) -> editorElement.getElement().scaleMultiplier = (value == null || value.isBlank()) ? PlayerMountHealthBarElement.DEFAULT_SCALE_STRING : value,
                        null, false, true,
        ...
        this.addIntegerInputContextMenuEntryTo(this.rightClickMenu, "hearts_per_row",
                        ...
                        Component.translatable("spiffyhud.elements.player_mount_health_bar.hearts_per_row"),
                        true, 10, null, null)
                .setStackable(true);
        ...
        this.addToggleContextMenuEntryTo(this.rightClickMenu, "blink_on_loss",
                        ...
                        "spiffyhud.elements.player_mount_health_bar.blink")
                .setStackable(true);
        ...
        this.addIntegerInputContextMenuEntryTo(this.rightClickMenu, "shake_threshold",
                        ...
                        Component.translatable("spiffyhud.elements.player_mount_health_bar.shake_threshold"),
                        true, 4, null, null)
                .setStackable(true);
        ...
        this.rightClickMenu.addSubMenuEntry("heart_textures",
                        Component.translatable("spiffyhud.elements.player_mount_health_bar.textures"),
                        texturesMenu)
                .setStackable(true)
    ...
    public PlayerMountHealthBarElement getElement() {
        return (PlayerMountHealthBarElement) this.element;
    }
