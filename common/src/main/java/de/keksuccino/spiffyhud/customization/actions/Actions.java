...
import de.keksuccino.spiffyhud.customization.actions.marker.ClearMarkersAction;
...
public class Actions {
    ...
    public static final ClearMarkersAction CLEAR_MARKERS = new ClearMarkersAction();
    ...
    public static void registerAll() {
        ...
        ActionRegistry.register(CLEAR_MARKERS);
